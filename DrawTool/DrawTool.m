...
% Last Modified by GUIDE v2.5 31-Oct-2017 19:26:15
...
var1 = get(handles.listbox1,'value');
switch var1
    case 1
...
switch var
    case 1
        set(DrawTool, 'color', 'g');
    case 2
        set(DrawTool, 'color', 'r');  
    case 3
        set(DrawTool, 'color', 'y');
    case 4
        set(DrawTool, 'color', 'w');
end
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
%COMM(handles.edit2,handles.popupmenu1,handles.listbox1);
com = get(handles.edit3,'string');
com = com{1};%将cell转换为string
eval(com);%就是将括号内的字符串视为语句并运行
